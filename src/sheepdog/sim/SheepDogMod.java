...
public class SheepDogMod
{
	...
	static Player loadPlayer(String group) {
        try {
            // get tools
            URL url = SheepDogMod.class.getProtectionDomain().getCodeSource().getLocation();
            // use the customized reloader, ensure clearing all static information
            ClassLoader loader = new ClassReloader(url, SheepDogMod.class.getClassLoader());
    ...
    SheepDogMod(Player[] players, int nsheeps, int nblacks, boolean mode)
    {
	...
	public static void main(String[] args) throws Exception
	{
        ...
        // create game
        SheepDogMod game = new SheepDogMod(players, nsheeps, nblacks, mode);
        // init game
        game.init();
        // play game
        if (gui) {
