...
public class Player extends sheepdog.sim.Player {
	...
	private final double VERTEX_PUSH_DISTANCE = 0.9; // how far the dog should push towards the CENTER at each vertex of the hull
	...
	private final double ENDGAME_SPEED = 0.8; // how quickly the dog should travel in endgame state (normal mode)
